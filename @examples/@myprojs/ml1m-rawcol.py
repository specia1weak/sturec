...
class SpecialModel(BaseModel):
    def __init__(self, schema_manager: SchemaManager,):
        ...
        self.history_emb = EmbView(self.omni_embedding, include_fields=["movie_id_seq", "genres_seq"])
        ...
        self.tar_project = nn.Linear(seq_dim, seq_dim)
    ...
    def concat_embed_input_fields(self, interaction):
        ...
        seq_emb, tar_emb, seq_len = self.omni_embedding.seq_groups["history"].fetch_all(interaction)
        seq_tar = tar_emb
...
if __name__ == '__main__':
    ...
    settings_list = [
        ...
        genres_setting,
        # SparseSeqEmbSetting("movie_id_seq", history_group, cfg.emb_dim, min_freq=10),
        SharedVocabSeqSetting("movie_id_seq", item_setting, history_group),
        SharedVocabSeqSetting("genres_seq", genres_setting, history_group),
    ]
