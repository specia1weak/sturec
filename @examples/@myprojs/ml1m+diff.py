...
if __name__ == '__main__':
    ...
    from betterbole.models.generative.diffusion.diffusions import RecSysEmbeddingModel
    from betterbole.models.generative.diffusion.schedulers import CosineDDPMScheduler
