...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="amazon_small", choices=("amazon_small", "amazon_large", "douban"))
    args = parser.parse_args()

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    dataset_map = {
        "amazon_small": DiffExperimentDataset.AMAZON_SMALL,
        "amazon_large": DiffExperimentDataset.AMAZON_LARGE,
